...
![OU structure in Active Directory Users and Computers](docs/screenshots/ad-users-and-computers-ou-structure.jpg)
...
![PowerShell ISE running Add-BulkUsers.ps1](docs/screenshots/powershell-bulk-users-output.jpg)
...
![GPO password policy settings](docs/screenshots/gpo-password-policy.jpg)
...
![GPO removable storage access settings](docs/screenshots/gpo-removable-storage.jpg)
